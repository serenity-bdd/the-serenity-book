...
chromeOptions.addArguments(((Map)enhancedCapabilities.caps.get("goog:chromeOptions")).get("args"))

chromeOptions.addExtensions(((Map)enhancedCapabilities.caps.get("goog:chromeOptions")).get("extensions"))
