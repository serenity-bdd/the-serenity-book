:source-dir: samples/frequent-flyer/src/test/java
...
{% codesnippet "{source-dir}/flyer/WhenEarningFrequentFlyerStatus.java", language="java" %}{% endcodesnippet %}
...
[source, java]
----
include::{source-dir}/flyer/steps/TravellerEarningStatusPoints.java[tags=preamble,joins,flies,should,tail]
----
