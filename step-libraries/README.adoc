...
[source, java]
----
include::samples/frequent-flyer/src/test/java/flyer/WhenEarningFrequentFlyerStatus.java[tags=classbody]
----
...
[source, java]
----
include::samples/frequent-flyer/src/test/java/flyer/steps/TravellerEarningStatusPoints.java[tags=preamble,joins,flies,should,tail]
----
...
[source, java]
----
include::samples/frequent-flyer/src/test/java/flyer/steps/TravellerEarningStatusPoints.java[tags=preamble,joins]
----
...
[source, java]
----
include::samples/frequent-flyer/src/test/java/flyer/WhenTransferringFrequentFlyerPoints.java[tags=classbody]
----
